...
import svgPaths from "../imports/svg-ibxgq5hxo0";
...
export default function EditableFrame() {
  ...
  const [texts, setTexts] = useState<EditableText[]>([
    ...
    { id: 'ai-content-1', value: 'The meeting focused on outlining the requirements for the next version of the GTM Partnership. Key details discussed included hardware upgrades, software enhancements, and design improvements tailored to meet the ', label: 'AI Content Part 1', type: 'textarea' },
    { id: 'ai-content-2', value: 'needs of both businesses.', label: 'AI Content Part 2', type: 'input' },
    { id: 'marketing-req', value: 'Marketing Requirements: Enhanced positioning in market for more visibility.', label: 'Marketing Requirements', type: 'textarea' },
    { id: 'software-enh', value: 'Software Enhancements: Integration of advanced real-time correction capabilities and ', label: 'Software Enhancements', type: 'textarea' },
    { id: 'expanded-compat', value: 'expanded compatibility .', label: 'Expanded Compatibility', type: 'input' },
  ...
  const downloadPNG = async () => {
    ...
    try {
      ...
      link.download = 'ai-companion-interface.png';
  ...
  // Component definitions from the complete Figma import
  function Frame28683() {
    return (
      <div
    ...
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="Pop window">
            <g id="Vector">
              <path d={svgPaths.p2d331200} fill="#555B62" />
              <path d={svgPaths.p19535300} fill="#555B62" />
            </g>
          </g>
        </svg>
      </div>
  ...
  function Close() {
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="Close">
            <path clipRule="evenodd" d={svgPaths.pfa8e200} fill="#555B62" fillRule="evenodd" id="Vector" />
          </g>
        </svg>
      </div>
    );
    ...
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="History">
            <g id="Vector">
              <path d={svgPaths.p14588f80} fill="#555B62" />
              <path d={svgPaths.p37982290} fill="#555B62" />
            </g>
          </g>
        </svg>
      </div>
    ...
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="Icon">
            <g id="Vector">
              <path d={svgPaths.pec08200} fill="#555B62" />
              <path d={svgPaths.p35b2ec00} fill="#555B62" />
              <path d={svgPaths.p30631000} fill="#555B62" />
            </g>
          </g>
        </svg>
      </div>
    ...
    return (
      <div className="box-border content-stretch flex gap-[3.125px] items-center justify-start p-0 relative shrink-0">
        <div className="font-['SF_Pro:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#323539] text-[21.873px] text-nowrap tracking-[-0.2343px]">
          <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">{getText('ai-content-2')}</p>
        </div>
        <Frame6266308 />
        <Frame6266310 />
      </div>
  ...
  function Frame1642958474() {
    return (
      <div className="box-border content-stretch flex flex-col items-start justify-start p-0 relative shrink-0 w-full">
        ...
        >
          <p className="block leading-[1.5]">{getText('ai-content-1')}</p>
        </div>
        <Frame1642958473 />
      </div>
    );
  ...
  function Frame1642958471() {
    return (
      <div className="box-border content-stretch flex gap-[3.125px] items-center justify-start p-0 relative shrink-0">
        <div className="font-['SF_Pro:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#323539] text-[21.873px] text-nowrap tracking-[-0.2343px]">
          <p className="adjustLetterSpacing block leading-[1.5] whitespace-pre">{getText('expanded-compat')}</p>
        </div>
        <Frame6266309 />
      </div>
    );
    ...
    return (
      ...
      >
        <div className="flex flex-col font-['SF_Pro:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#323539] text-[18.748px] text-center text-nowrap">
          <p className="block leading-[24.997px] whitespace-pre">{getText('sources-text')}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
          <g id="Copy">
            <g id="Vector">
              <path d={svgPaths.p22865520} fill="#6E7680" />
              <path clipRule="evenodd" d={svgPaths.p14fa5200} fill="#6E7680" fillRule="evenodd" />
            </g>
          </g>
        </svg>
      </div>
    ...
    return (
      <div className="box-border content-stretch flex flex-col gap-[6.249px] items-start justify-start p-0 relative shrink-0 w-[465.573px]">
        <div
          ...
          style={{ width: "min-content" }}
        >
          <p className="block leading-[28.122px]">{getText('ai-title')}</p>
        </div>
        <Frame1642958474 />
        <Frame1642958472 />
        <Frame28820 />
    ...
    return (
      <div className="basis-0 box-border content-stretch flex gap-[6.249px] grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
        <div className="basis-0 flex flex-col font-['SF_Pro:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#323539] text-[18.748px]">
          <p className="block leading-[24.997px]">{getText('prompt-1')}</p>
        </div>
      </div>
    );
  }
  ...
  function Frame1642958764() {
    return (
      <div className="basis-0 box-border content-stretch flex gap-[6.249px] grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
        <div className="basis-0 flex flex-col font-['SF_Pro:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#323539] text-[18.748px]">
          <p className="block leading-[24.997px]">{getText('prompt-2')}</p>
        </div>
      </div>
    );
  }
  ...
  function Frame1642958765() {
    return (
      <div className="basis-0 box-border content-stretch flex gap-[6.249px] grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
        <div className="basis-0 flex flex-col font-['SF_Pro:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#323539] text-[18.748px]">
          <p className="block leading-[24.997px]">{getText('prompt-3')}</p>
        </div>
      </div>
    );
  }
  ...
  function Frame1642958766() {
    return (
      <div className="basis-0 box-border content-stretch flex gap-[6.249px] grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0">
        <div className="basis-0 flex flex-col font-['SF_Pro:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#323539] text-[18.748px]">
          <p className="block leading-[24.997px]">{getText('prompt-4')}</p>
        </div>
      </div>
    );
  }
  ...
  function Icon4() {
    return (
      ...
      >
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 25 25">
          <g id="Icon">
            <path d={svgPaths.p10696180} fill="#C5C8CD" id="Vector" />
          </g>
        </svg>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">AI Companion Editor</h1>
