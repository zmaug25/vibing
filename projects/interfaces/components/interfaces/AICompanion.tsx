...
export default function AICompanion({ getText }: AICompanionProps) {
  ...
  // First paragraph with citations (1)(2)
  function FirstParagraphWithCitations() {
    return (
      <div className="box-border content-stretch flex gap-[3.125px] items-end justify-start p-0 relative shrink-0 w-full">
        <div
          className="font-['SF_Pro:Regular',_sans-serif] leading-[0] flex-1 not-italic relative shrink-0 text-[#323539] text-[21.873px] tracking-[-0.2343px]"
        >
          <p className="block leading-[1.5]">{getText('ai-paragraph-1')}</p>
        </div>
        <div className="flex gap-[3.125px] items-center">
          <Frame6266308 />
          <Frame6266310 />
        </div>
      </div>
  ...
  // Second paragraph with citation (3)
  function SecondParagraphWithCitations() {
    return (
      <div className="box-border content-stretch flex gap-[3.125px] items-end justify-start p-0 relative shrink-0 w-full">
        <div
          className="font-['SF_Pro:Regular',_sans-serif] leading-[0] flex-1 not-italic relative shrink-0 text-[#323539] text-[21.873px] tracking-[-0.2343px]"
        >
          <p className="block leading-[1.5]">{getText('ai-paragraph-2')}</p>
        </div>
        <div className="flex gap-[3.125px] items-center">
          <Frame6266309 />
        </div>
  ...
  function Frame28831() {
    return (
      <div className="box-border content-stretch flex flex-col gap-[6.249px] items-start justify-start p-0 relative shrink-0 w-[465.573px]">
        ...
        <FirstParagraphWithCitations />
        <SecondParagraphWithCitations />
        <Frame28820 />
        <Frame28828 />
      </div>
    );
